...
(defproject org.clojars.pmonks/lambdalf "0.2.0-SNAPSHOT"
  ...
  :repositories [
                  ...
                  ["alfresco.private" "https://artifacts.alfresco.com/nexus/content/groups/private/"]
                ]
  :dependencies [
  ...
  :profiles {:dev        { :plugins [[lein-amp "0.1.0-SNAPSHOT"]] }
             ...
             :enterprise { :dependencies [
                                           [org.alfresco/alfresco-core       "4.2.2" :scope "runtime"]
                                           [org.alfresco/alfresco-data-model "4.2.2" :scope "runtime"]
                                           [org.alfresco/alfresco-mbeans     "4.2.2" :scope "runtime"]
                                           [org.alfresco/alfresco-remote-api "4.2.2" :scope "runtime"]
                                           [org.alfresco/alfresco-repository "4.2.2" :scope "runtime"]
                                         ] }
           }
